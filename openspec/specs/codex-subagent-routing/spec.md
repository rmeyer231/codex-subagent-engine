# Codex Subagent Routing Specification

## Purpose

Define deterministic native Codex role routing, permissions, orchestration ownership, concurrency, and model inheritance.
